...
<template>
  <div h-screen flex="~ col gap4" items-center justify-center w-160 text-center mxa>
    <div flex="~" justify-center items-center>
      <NuxtLogo h-16 />
      <Badge
        bg-green-400:10 text-green-400 mr--15 mt--5
        title="preview"
        v-text="'preview'"
      />
    </div>
    <p text-xl font-bold my2>
