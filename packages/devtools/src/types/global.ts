...
import type { LoadingTimeMetric, NuxtDevtoolsIframeClient, NuxtDevtoolsGlobal as NuxtDevtoolsViewGlobal, PluginMetric, TimlineMetrics } from '.'
...
declare global {
  interface Window {
     ...
     * @internal
     */
    __NUXT_DEVTOOLS_TIMELINE_METRICS__?: TimlineMetrics
