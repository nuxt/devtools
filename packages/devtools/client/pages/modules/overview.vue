      ...
      <div flex="~ gap2 wrap">
        ...
        <template v-if="config">
          ...
          >
            ...
            <div>{{ pluralizeByCount(routes.length, 'page', 'pages') }}</div>
          </NuxtLink>
          <NuxtLink v-if="config" min-w-40 p4 theme-card-lime flex="~ col auto" to="/modules/components">
            ...
            <div>{{ pluralizeByCount(components.length, 'component', 'components') }}</div>
          </NuxtLink>
