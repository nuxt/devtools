...
::callout
**Deprecated**: `@nuxt/devtools-ui-kit` is deprecated and no longer recommended for new integrations. This page is kept for existing consumers only — please do not build new DevTools integrations against it.
::
