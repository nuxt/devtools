...
On Vite 8.3+, Vite itself registers the Vite DevTools integration from its top-level [`devtools` option](https://vite.dev/config/shared-options#devtools) ([vitejs/vite#23333](https://github.com/vitejs/vite/pull/23333)), which Nuxt DevTools configures for you. That keeps the toggle in your hands — you can turn Vite DevTools off from your Vite config:
...
On older Vite versions, Nuxt DevTools falls back to registering the Vite DevTools plugin itself.
