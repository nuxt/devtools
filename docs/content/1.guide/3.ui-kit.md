...
::alert
We suggest you to read the [Module Authors Guide](/module-authors) first.
::
...
We recommend to use the [Starter Template](/module-authors#starter-template) for authoring a DevTools integration for your module, which has the set up built in and ready to use.
