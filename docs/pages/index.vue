  ...
  <ULandingSection v-for="(section, index) of page.sections" :key="index" v-bind="section">
        ...
        <ul class="flex flex-col items-center justify-center lg:w-[40%]">
          <li v-for="(project, index) in section.projectCards" :key="index">
            ...
            >
              ...
              <UButton
                :to="project.to" trailing-icon="i-ph-arrow-right" variant="link" color="white" size="md"
      ...
      >
        ...
        <template #links>
          <UAvatarGroup :max="13" size="md" class="flex-wrap lg:self-start [&_span:first-child]:text-xs">
            <UTooltip
              v-for="(contributor, index) of module.contributors" :key="index" :text="contributor.username"
    ...
    <template #get-started>
      <div class="w-full flex flex-col items-center justify-center">
        ...
        <UButton
          to="/guide" size="xl" :label="section.button" variant="outline" color="transparent"
          class="mt-8 w-fit"
        />
      </div>
    </template>
